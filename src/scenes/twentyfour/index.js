...
class home extends Component {
  constructor(props) {
    ...
    this.state = {
      FlatListItems: [
        {
          name: 'أيام العشر فرصتك',
          id: 1,
          audiPath: 'https://gdurl.com/FtK1',
          isOpend: false,
          path: require('_assets/images/12/6.jpeg'),
          },
        {
          name: 'يا بنت الإسلام أقبلت العشر',
          id: 2,
          audiPath: 'https://gdurl.com/zgXJ',
    ...
    return (
      <View
        ...
        <ImageBackground
          ...
          <Text style={styles.title}>العشر من ذي الحجة</Text>
          <ScrollView>
          <FlatList
