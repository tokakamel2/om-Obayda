...
class home extends Component {
  constructor(props) {
    ...
    this.state = {
      FlatListItems: [
        {
          name: 'حلول المشاكل الزوجية',
          id: 1,
          audiPath: 'https://gdurl.com/g8zZ',
        ...
        {
          name: 'تسأل كيف تتعامل مع زوجها',
          id: 2,
          audiPath: 'https://gdurl.com/n_o5',
    ...
    return (
      <View
        ...
        <ImageBackground
          ...
          <Text style={styles.title}>حلول المشاكل الزوجية</Text>
          <ScrollView>
          <FlatList
