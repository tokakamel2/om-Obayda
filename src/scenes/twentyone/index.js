...
class home extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      {name:'حق الوالدين',
      id:15,
      audiPath:'https://gdurl.com/9Gw2',
      audiPath2:'https://gdurl.com/eR4E',
      text: '8',
    },
    {name:'تكملة حق الوالدين',
    id:15,
    audiPath: 'https://gdurl.com/Yp8Y',
    audiPath2: 'https://gdurl.com/Jilm',
    text: '8',
  },
  {name:'حق المسلم',
  id:15,
  audiPath:'https://gdurl.com/qNPY',
  audiPath2: 'https://gdurl.com/pxdq',
...
{name:'حق الرحم',
id:15,
audiPath: 'https://gdurl.com/MiD0',
audiPath2:'https://gdurl.com/RSWY',
text: '8',
},
{name:'حق الجار',
id:15,
